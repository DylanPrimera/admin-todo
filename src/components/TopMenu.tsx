    ...
    <div className="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
      <div className="px-6 flex items-center justify-between space-x-4">
        ...
        <div className="flex space-x-2">
          ...
          <button className="flex items-center justify-center  h-10 p-2 gap-2 rounded-xl border bg-gray-100 focus:bg-gray-100 active:bg-gray-200">
            <span className="text-sm  text-blue-800 font-bold">{ getTotalProducts() }</span>
